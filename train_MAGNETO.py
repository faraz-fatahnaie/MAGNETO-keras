...
from utils import parse_data, set_seed, get_result
...
def train_MAGNETO():
    ...
    train = pd.read_csv(os.path.join(BASE_DIR, 'dataset', f'{dataset_name}', 'train_binary.csv'))
    test = pd.read_csv(os.path.join(BASE_DIR, 'dataset', f'{dataset_name}', 'test_binary.csv'))
